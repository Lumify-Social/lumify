 ...
 */
final class Version20250123090510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE roles roles JSON DEFAULT \'[]\' NOT NULL COMMENT \'(DC2Type:json)\'');
    }
